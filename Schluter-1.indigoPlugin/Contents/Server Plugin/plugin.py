...
#				tempthermo.temperature = self.schluter.temp_convert_from(tempthermo.temperature, self.pluginPrefs["temperatureScale"])
				self.logger.info(u"Current temp: %s °%s",self.schluter.temp_convert_from(tempthermo.temperature, self.pluginPrefs["temperatureScale"]), self.pluginPrefs["temperatureScale"])
