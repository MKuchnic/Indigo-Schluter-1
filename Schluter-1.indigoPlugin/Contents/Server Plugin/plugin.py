...
#				debug checking 
	...
	def _updateDeviceStatesList(self, dev, thermostat):
		...
		self.logger.debug(u"_changeTempSensorValue: value = {}, uiValue = {}".format(self.temperatureFormatter.convertFromSchluter(thermostat.temperature), self.temperatureFormatter.format(thermostat.temperature).encode('utf-8')))
		...
		self.logger.debug(u"_changeTempSetpoint: value = {}, uiValue = {}".format(self.temperatureFormatter.convertFromSchluter(thermostat.set_point_temp),self.temperatureFormatter.format(thermostat.set_point_temp).encode('utf-8')))
