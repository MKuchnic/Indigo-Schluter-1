...
# fix it once tempformatter fixed
				self.logger.info(u"Current temp: %s °%s",self.temperatureFormatter.convertFromSchuter(tempthermo.temperature), self.temperatureFormatter.format(tempthermo.temperature))
